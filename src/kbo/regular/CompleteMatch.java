...
public class CompleteMatch extends RegularGame {
    ...
    public CompleteMatch(LocalDate matchDate, String stadium,
    ...
    private Result calcResult() {
        if      (homeScore > awayScore) return Result.HOME_WIN;
        else if (awayScore > homeScore) return Result.AWAY_WIN;
